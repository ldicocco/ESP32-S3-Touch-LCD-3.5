 ...
 * (`oxivgl::mem::reserve_pool`, which puts LVGL's heap in PSRAM): under
 ...
 * The panic reports over USB-serial-JTAG via esp-backtrace, with LVGL's own
 * log line (expression, file, line) immediately above it. The symbol is
 * provided by oxivgl >= 0.6.0. */
